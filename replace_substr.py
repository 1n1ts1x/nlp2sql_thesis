...
class ReplaceSubstring:
    ...
    def replace_sub_str(self):
        ...
        input_query_txt = re.sub(r'\beach of the plants\b', ' of all plant', input_query_txt)
        input_query_txt = re.sub(r'\beach of the plant\b', ' of all plant', input_query_txt)
        ...
        input_query_txt = re.sub(r'\bany of the plants\b', ' of all plant', input_query_txt)
        input_query_txt = re.sub(r'\bany of the plant\b', ' of all plant', input_query_txt)
        ...
        input_query_txt = re.sub(r'\bany of the data\b', ' all', input_query_txt)
        ...
        input_query_txt = re.sub(r'\ball of the data of the\b', 'temperature', input_query_txt)
        input_query_txt = re.sub(r'\bdata of the temperature\b', 'temperature', input_query_txt)
        input_query_txt = re.sub(r'\bdata of the humidity\b', 'humidity', input_query_txt)
        input_query_txt = re.sub(r'\bdata of the soil\b', 'soil', input_query_txt)
        input_query_txt = re.sub(r'\bdata of the light\b', 'temperature', input_query_txt)
        input_query_txt = re.sub(r'\bdata of the air\b', 'humidity', input_query_txt)
        ...
        input_query_txt = re.sub(r'\bdata of the all\b', ' all', input_query_txt)
        input_query_txt = re.sub(r'\bdata of all\b', ' all', input_query_txt)
        input_query_txt = re.sub(r'\bdata of the\b', '', input_query_txt)
