...
class ReplaceSubstring:
    ...
    def replace_sub_str(self):
        ...
        input_query_txt = re.sub(r'\bcrop of grape\b', 'grape plant', input_query_txt)
        input_query_txt = re.sub(r'\bcrops of wheat\b', 'wheat plant', input_query_txt)
        ...
        input_query_txt = re.sub(r'\ball farms\b', ' all plants', input_query_txt)
        input_query_txt = re.sub(r'\bin the tomato\b', 'from the tomato', input_query_txt)
        input_query_txt = re.sub(r'\bin the grape\b', 'from the grape', input_query_txt)
        input_query_txt = re.sub(r'\bin the wheat\b', 'from the wheat', input_query_txt)
        input_query_txt = re.sub(r'\bin the corn\b', 'from the corn', input_query_txt)
        input_query_txt = re.sub(r'\bdisplay the tomato\b', 'show all from tomato', input_query_txt)
        input_query_txt = re.sub(r'\bdisplay the grape\b', 'show all from grape', input_query_txt)
        input_query_txt = re.sub(r'\bdisplay the wheat\b', 'show all from wheat', input_query_txt)
        input_query_txt = re.sub(r'\bdisplay the corn\b', 'show all from corn', input_query_txt)

        input_query_txt = re.sub(r'\blist the tomato\b', 'show all from tomato', input_query_txt)
        input_query_txt = re.sub(r'\blist the grape\b', 'show all from grape', input_query_txt)
        input_query_txt = re.sub(r'\blist the wheat\b', 'show all from wheat', input_query_txt)
        input_query_txt = re.sub(r'\blist the corn\b', 'show all from corn', input_query_txt)

        input_query_txt = re.sub(r'\bshow the tomato\b', 'show all from tomato', input_query_txt)
        input_query_txt = re.sub(r'\bshow the grape\b', 'show all from grape', input_query_txt)
        input_query_txt = re.sub(r'\bshow the wheat\b', 'show all from wheat', input_query_txt)
        input_query_txt = re.sub(r'\bshow the corn\b', 'show all from corn', input_query_txt)

        input_query_txt = re.sub(r'\bpresent the tomato\b', 'show all from tomato', input_query_txt)
        input_query_txt = re.sub(r'\bpresent the grape\b', 'show all from grape', input_query_txt)
        input_query_txt = re.sub(r'\bpresent the wheat\b', 'show all from wheat', input_query_txt)
        input_query_txt = re.sub(r'\bpresent the corn\b', 'show all from corn', input_query_txt)

        input_query_txt = re.sub(r'\bview the tomato\b', 'show all from tomato', input_query_txt)
        input_query_txt = re.sub(r'\bview the grape\b', 'show all from grape', input_query_txt)
        input_query_txt = re.sub(r'\bview the wheat\b', 'show all from wheat', input_query_txt)
        input_query_txt = re.sub(r'\bview the corn\b', 'show all from corn', input_query_txt)
        ...
        input_query_txt = re.sub(r'\btomatoes\b', 'tomato plant', input_query_txt)
        input_query_txt = re.sub(r'\bgrapes\b', 'grape plant', input_query_txt)
        ...
        input_query_txt = re.sub(r'\bmonitor\b', 'show', input_query_txt)
        ...
        input_query_txt = input_query_txt.replace('more than', ' above')
        ...
        input_query_txt = re.sub(r'\bmoisture\b', 'soil', input_query_txt)    
