...
#             if "tomato" not in input_query_txt and "corn" not in input_query_txt and "wheat" not in input_query_txt and "grape" not in input_query_txt:
#                 self.isOptimalParam = input_query_txt

#                 items_to_remove = ["air", "soil", "humidity", "light", "temperature", "quality", "moisture", "intensity"]

#                 new_string = input_query_txt
#                 for item in items_to_remove:
#                     new_string = new_string.replace(item, "")

#                 input_query_txt = "show all " + new_string
#             else:
#                 self.isOptimalParam = False
#         else:
#             self.isOptimal = False
...
#         if self.isOptimalParam:
#             params = ["light", "temperature", "soil", "air", "humidity"]

#             found_params = [item for item in params if item in self.isOptimalParam]
